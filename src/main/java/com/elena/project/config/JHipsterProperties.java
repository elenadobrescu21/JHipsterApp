...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "elena.alexandra.dobrescu@gmail.com";
    ...
    public static class Swagger {
        ...
        private String title = "elena API";

        private String description = "elena API documentation";
